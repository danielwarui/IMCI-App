			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				if (groupPosition == 1 && childPosition == 0) {
					Intent intent = new Intent(What_to_Check_0_2.this,
							com.chai.imci.Assessment.Starter_0_2_Diarrhoea.class);
					startActivity(intent);

				}
				if (groupPosition == 2 && childPosition == 0) {
					Intent intent = new Intent(What_to_Check_0_2.this,
							com.chai.imci.Assessment.Starter_0_2_Severe_Disease.class);
					startActivity(intent);

				}
				if (groupPosition == 2 && childPosition == 1) {
					Intent intent = new Intent(What_to_Check_0_2.this,
							com.chai.imci.Assessment.Starter_0_2_Jaundice.class);
					startActivity(intent);

				}
				if (groupPosition == 2 && childPosition == 2) {
					Intent intent = new Intent(What_to_Check_0_2.this,
							com.chai.imci.Assessment.Starter_0_2_EyeInfection.class);
					startActivity(intent);

				}
				if (groupPosition == 2 && childPosition == 3) {
					Intent intent = new Intent(What_to_Check_0_2.this,
							com.chai.imci.Assessment.Starter_0_2_HIVExposure.class);
					startActivity(intent);
