			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				if (groupPosition == 1 && childPosition == 0) {
					Intent intent = new Intent(What_to_Check_2_60.this,
							com.chai.imci.Assessment.Starter_2_60_Cough.class);
					startActivity(intent);

				}
				if (groupPosition == 1 && childPosition == 1) {
					Intent intent = new Intent(What_to_Check_2_60.this,
							com.chai.imci.Assessment.Starter_2_60_Diarr.class);
					startActivity(intent);

				}
				if (groupPosition == 1 && childPosition == 2) {
					Intent intent = new Intent(What_to_Check_2_60.this,
							com.chai.imci.Assessment.Starter_2_60_Fever.class);
					startActivity(intent);

				}
				if (groupPosition == 1 && childPosition == 3) {
					Intent intent = new Intent(What_to_Check_2_60.this,
							com.chai.imci.Assessment.Starter_2_60_Ear_Problem.class);
					startActivity(intent);

				}
				if (groupPosition == 2 && childPosition == 0) {
					Intent intent = new Intent(What_to_Check_2_60.this,
							com.chai.imci.Assessment.Starter_2_60_Malnutrition.class);
					startActivity(intent);

				}
				if (groupPosition == 2 && childPosition == 1) {
					Intent intent = new Intent(What_to_Check_2_60.this,
							com.chai.imci.Assessment.Starter_2_60_Anaemia.class);
					startActivity(intent);
				...
				if (groupPosition == 2 && childPosition == 2) {
					Intent intent = new Intent(What_to_Check_2_60.this,
							com.chai.imci.Assessment.Starter_2_60_Hiv.class);
					startActivity(intent);

				}
				if (groupPosition == 2 && childPosition == 3) {
					Intent intent = new Intent(What_to_Check_2_60.this,
							com.chai.imci.Assessment.Starter_2_60_Immunization.class);
					startActivity(intent);
