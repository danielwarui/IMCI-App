...
public class Young_Expand_Disease_Special extends Activity {
	...
	private void prepareListData() {
		...
		// Adding child data
		listDataHeader.add("Severe Pneumonia Or Very Severe Disease");
		listDataHeader.add("Pneumonia");
		listDataHeader.add("No Pneumonia Just A Cold");

		// Adding child data
		// top250 is an entry of the major list
		List<String> malaria = new ArrayList<String>();
		// adding sublists to the entity top250
		malaria.add("Any general danger sign");
		malaria.add("Chest in drawing ");
		malaria.add("Stridor in calm child");
		

		List<String> Dehydration = new ArrayList<String>();
		Dehydration.add("Fast Breathing");

		List<String> Pneumonia = new ArrayList<String>();
		Pneumonia.add("No sign of pneumonia or very severe disease");
