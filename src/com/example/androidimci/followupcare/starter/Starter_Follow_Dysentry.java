...
public class Starter_Follow_Dysentry  extends FragmentActivity implements
ActionBar.TabListener {
	private ViewPager viewPager;
	private TabsPagerFollowDysentry mAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAdapter = new TabsPagerFollowDysentry(getSupportFragmentManager());
