...
public class Oral_Drugs_2_60_At extends Activity {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				if (groupPosition == 0 && childPosition == 0) {
					Intent intent = new Intent(
							...
							com.example.androidimci.treatthechild.Teach_Mother_Oral_Drugs.class);
				...
				if (groupPosition == 1 && childPosition == 0) {
					Intent intent = new Intent(
							Oral_Drugs_2_60_At.this,
							com.example.androidimci.treatthechild.Teach_Mother_Local_Infections.class);
					startActivity(intent);
				...
				if (groupPosition == 2 && childPosition == 0) {
					Intent intent = new Intent(
							Oral_Drugs_2_60_At.this,
							com.example.androidimci.treatthechild.Treatment_Health_Facility.class);
					startActivity(intent);
				...
				if (groupPosition == 3 && childPosition == 0) {
					Intent intent = new Intent(
							Oral_Drugs_2_60_At.this,
							com.example.androidimci.treatthechild.Plan_A_Treat_Diarrhoea.class);
					startActivity(intent);
				...
				if (groupPosition == 3 && childPosition == 1) {
					Intent intent = new Intent(
							Oral_Drugs_2_60_At.this,
							com.example.androidimci.treatthechild.Plan_B_Treat_Diarrhoea.class);
					startActivity(intent);
				...
				if (groupPosition == 3 && childPosition == 2) {
					Intent intent = new Intent(
							Oral_Drugs_2_60_At.this,
							com.example.androidimci.treatthechild.Plan_C_Treat_Diarrhoea.class);
					startActivity(intent);
	...
	private void prepareListData() {
		...
		listDataHeader
				.add("Treat the mother to treat local infections at home");
		...
		listDataHeader
				.add("Rehydration therapy for diarrhoea for children with severe malnutrition");
		listDataHeader
				.add("Give multivitamin/ mineral supplement for persistent diarrhoea");
		// Adding child data
