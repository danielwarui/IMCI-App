...
import com.example.androidimci.treatthechild.zero_two.Treat_Child_Activity_0_2;
		...
		expListView.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				if (groupPosition == 2 && childPosition == 0) {
					Intent intent = new Intent(Oral_Drugs_0_2_At.this,
							com.example.androidimci.treatthechild.Young_Treatment_Health_Facility.class);
				...
				if (groupPosition == 3 && childPosition == 0) {
					Intent intent = new Intent(Oral_Drugs_0_2_At.this,
							com.example.androidimci.treatthechild.oral_drugs.Young_Oral_Drugs_At_Home.class);
				...
				if (groupPosition == 4 && childPosition == 0) {
					Intent intent = new Intent(Oral_Drugs_0_2_At.this,
							com.example.androidimci.treatthechild.local_infections.Young_Local_Infections_At_Home.class);
				...
				if (groupPosition == 5 && childPosition == 0) {
					Intent intent = new Intent(Oral_Drugs_0_2_At.this,
							com.example.androidimci.treatthechild.Young_Teach_Correct_Positioning.class);
				...
				if (groupPosition == 2 && childPosition == 4) {
					Intent intent = new Intent(Oral_Drugs_0_2_At.this,
							com.chai.imci.Assessment.Starter_0_2_FeedingProblem.class);
				...
				if (groupPosition == 2 && childPosition == 5) {
					Intent intent = new Intent(Oral_Drugs_0_2_At.this,
							com.chai.imci.Assessment.Starter_0_2_SpecialTreatments.class);
