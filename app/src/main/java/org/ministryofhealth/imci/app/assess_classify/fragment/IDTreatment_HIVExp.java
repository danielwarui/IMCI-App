...
public class IDTreatment_HIVExp extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        signsUnlikelyBact = getString(R.string.young_treatment_symptomatic);
        severeProlonged = getString(R.string.young_treatment_hiv_infection_unlikely);
		/*
