...
public class Classify_Malnutrition extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        signsSevereDiseases = getString(R.string.signs_severe_acute_malnutrition);
        signsLocalBacteria = getString(R.string.signs_moderate_acute_malnutrition);
        signsUnlikelyBact = getString(R.string.signs_at_risk_malnutrition);
        signsLowBodyTemp = getString(R.string.signs_no_malnutrition);
		/*
