...
public class Infant_Classify_VerySevereDisease extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        signsSevereDiseases = getString(R.string.young_signs_very_severe_disease);
        signsLocalBacteria = getString(R.string.young_signs_local_bacterial_infection);
        signsUnlikelyBact = getString(R.string.young_signs_unlikely_bact_severe_disease);
        signsLowBodyTemp = getString(R.string.young_signs_low_body_temperature);
		/*
