...
public class Classify_Cough_Difficulty extends Fragment {
...
*/
        ...
        signsSevereDiseases = getString(R.string.signs_severe_pneumonia);
        signsLocalBacteria = getString(R.string.signs_pneumonia);
        signsUnlikelyBact = getString(R.string.signs_no_pneumonia);
		/*
