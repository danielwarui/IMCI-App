...
public class Infant_IDTreatment_SpecialTreatment extends Fragment {
...
*/
        signsSquint = getString(R.string.young_treatment_risk_bact);
        signsCongenitalCancer = getString(R.string.young_treatment_risk_syphilis);
        signsCongenitalGlaucoma = getString(R.string.young_treatment_risk_transmission_hiv);
        signsSevereEyeInfection = getString(R.string.young_treatment_risk_TB);
