...
public class Infant_IDTreatment_FeedingLow extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		 ...
		 */
        signsSevereDehydration = getString(R.string.young_treatment_feeding_problem);
        signsSomeDehydration = getString(R.string.young_treatment_no_feeding_problem);

        noDehydration = getString(R.string.young_treatment_very_low_birth);
        severeProlonged = getString(R.string.young_treatment_low_birth_weight);
        possibleAbdominal = getString(R.string.young_treatment_normal_birth_weight);
