...
public class Classify_Diarrhoea extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        signsnoDehydration = getString(R.string.signs_no_dehydration);
        signsSeverePersistent = getString(R.string.signs_severe_persistent_diarrhoea);
        signsPeristentDiarrhoea = getString(R.string.signs_persistent_diarrhoea);
        signsDysentry = getString(R.string.signs_dysentry);
