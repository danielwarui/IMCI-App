...
public class Infant_IDTreatment_Jaundice extends Fragment {
...
*/
        ...
        signsSevereDiseases = getString(R.string.young_treatment_severe_jaundice);
        signsLocalBacteria = getString(R.string.young_treatment_jaundice);
        signsUnlikelyBact = getString(R.string.young_treatment_no_jaundice);
		/*
