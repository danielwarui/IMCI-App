...
public class Classify_Fever extends Fragment {
    ...
    String signsSevereFebrile, signsMalaria, signsnoMalaria,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		 ...
		 */
        signsSevereFebrile = getString(R.string.signs_very_severe_febrile_disease);
        signsMalaria = getString(R.string.signs_malaria);
        signsnoMalaria = getString(R.string.signs_fever_no_malaria);
        ...
        signsEye = getString(R.string.signs_eye_mouth);
        signsNoEye = getString(R.string.signs_no_eye_mouth);
