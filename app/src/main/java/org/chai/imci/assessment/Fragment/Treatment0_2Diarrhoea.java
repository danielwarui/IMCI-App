...
public class Treatment0_2Diarrhoea extends Fragment {
	...
	String treat_severe_dehydration, treat_some_dehydration,
			treat_no_dehydration, treat_severe_prolonged_diarrhoea,
			treat_persistent_diarrhoea, treat_dysentry;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mItemListArray2.add(new ItemList("", treat_severe_prolonged_diarrhoea));
