...
public class SignDiarrhoea extends Fragment {
	...
	String signsSevereDehydration, signsSomeDehydration, noDehydration, severeProlonged,ProlongedDiarrhoea,possibleAbdominal;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		severeProlonged = getString(R.string.signs_severe_persistent_diarrhoea);
		ProlongedDiarrhoea = getString(R.string.signs_persistent_diarrhoea);
		...
		ArrayList<SubCategory.ItemList> mItemListArrayP2 = new ArrayList<ItemList>();
		mItemListArrayP2.add(new ItemList("", noDehydration));

		ArrayList<SubCategory.ItemList> mItemListArray2 = new ArrayList<ItemList>();
		mItemListArray2.add(new ItemList("", severeProlonged));
		ArrayList<ItemList> mItemListArray2P1 = new ArrayList<ItemList>();
		mItemListArray2P1.add(new ItemList("", ProlongedDiarrhoea));
