...
public class Treatment_Fever extends Fragment {
	...
	private void prepareListData() {
		...
		treat_low_severe_febrile_disease = getResources().getString(
				R.string.severe_febrile_disease_treatment);
		...
		// adding sublists to the entity top250
		symptoms.add(treat_low_severe_febrile_disease);
		symptoms.add(treat_low_malaria);
		symptoms.add(treat_low_fever_no_malaria);
