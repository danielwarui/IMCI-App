...
public class IDTreatment_Malnutrition extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        signsSevereDiseases = getString(R.string.severe_acute_malnutrition_treatment);
        signsLocalBacteria = getString(R.string.moderate_acute_malnutrition_treatment);
        signsUnlikelyBact = getString(R.string.at_risk_malnutrition_treatment);
        signsLowBodyTemp = getString(R.string.no_malnutrition_treatment);
		/*
