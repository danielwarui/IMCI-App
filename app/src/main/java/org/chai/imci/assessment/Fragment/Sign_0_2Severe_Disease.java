...
public class Sign_0_2Severe_Disease extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		pSubItemArrayList.add(new SubCategory("SEVERE \n DEHYDRATION",mItemListArray));
		pSubItemArrayList.add(new SubCategory("SOME \n DEHYDRATION",mItemListArrayP1));
		pSubItemArrayList.add(new SubCategory("NO \n DEHYDRATION",mItemListArrayP2));

		pSubItemArrayList2.add(new SubCategory("SEVERE \n PROLONGED \n DIARRHOEA", mItemListArray2));
		pSubItemArrayList3.add(new SubCategory("POSSIBLE SERIOUS \n ABDOMINAL \n PROBLEM", mItemListArray3));
		...
		pProductArrayList.add(new Product("Low Body Temperature",pSubItemArrayList3));
