...
public class IDTreatment_Ear_Problem extends Fragment {
...
*/
        ...
        signsUnlikelyBact = getString(R.string.chronic_ear_infection_treatment);
        severeProlonged = getString(R.string.no_ear_infection_treatment);
		/*
