...
public class Classify_Ear_Problem extends Fragment {
...
*/
        ...
        signsSevereDiseases = getString(R.string.signs_mastoditis);
        signsLocalBacteria = getString(R.string.signs_acute_ear_infection);
        signsUnlikelyBact = getString(R.string.signs_chronic_infection);
        severeProlonged = getString(R.string.signs_no_ear_infection);
		/*
        ...
        pSubItemArrayList4.add(new SubCategory(severeProlonged, itemNothing));
