...
public class Young_Expand_Disease_Low_Weight extends Activity {
    ...
    private void prepareListData() {
        ...
        // Adding child data
        listDataHeader.add("Very Low Birth Weight");
        listDataHeader.add("Low Birth Weight");
        listDataHeader.add("Normal Birth Weight");

        // Adding child data
        // top250 is an entry of the major list
        List<String> malaria = new ArrayList<String>();
        // adding sublists to the entity top250
        malaria.add("Weight less than 2kg");

        List<String> Dehydration = new ArrayList<String>();
        Dehydration.add("Weight between 2kg and 2.5kg");

        List<String> Pneumonia = new ArrayList<String>();
        Pneumonia.add("Weight 2.5 kg or more");
